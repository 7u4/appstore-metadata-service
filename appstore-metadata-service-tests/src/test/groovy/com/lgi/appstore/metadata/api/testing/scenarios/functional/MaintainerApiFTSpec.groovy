...
package com.lgi.appstore.metadata.api.testing.scenarios.functional

import com.lgi.appstore.metadata.api.testing.AsmsFeatureSpecBase
import com.lgi.appstore.metadata.api.testing.framework.model.response.ApplicationDetailsPath
...
import static com.lgi.appstore.metadata.api.testing.framework.model.request.ApiMaintainerApplicationsQueryParams.CATEGORY
import static com.lgi.appstore.metadata.api.testing.framework.model.request.ApiMaintainerApplicationsQueryParams.DESCRIPTION
import static com.lgi.appstore.metadata.api.testing.framework.model.request.ApiMaintainerApplicationsQueryParams.LIMIT
import static com.lgi.appstore.metadata.api.testing.framework.model.request.ApiMaintainerApplicationsQueryParams.NAME
import static com.lgi.appstore.metadata.api.testing.framework.model.request.ApiMaintainerApplicationsQueryParams.OFFSET
import static com.lgi.appstore.metadata.api.testing.framework.model.request.ApiMaintainerApplicationsQueryParams.PLATFORM
import static com.lgi.appstore.metadata.api.testing.framework.model.request.ApiMaintainerApplicationsQueryParams.TYPE
import static com.lgi.appstore.metadata.api.testing.framework.model.request.ApiMaintainerApplicationsQueryParams.VERSION
import static com.lgi.appstore.metadata.api.testing.framework.model.request.ApplicationMetadataBuilder.builder
import static com.lgi.appstore.metadata.api.testing.framework.model.request.QueryParams.mapping
import static com.lgi.appstore.metadata.api.testing.framework.model.request.QueryParams.queryParams
import static com.lgi.appstore.metadata.api.testing.framework.model.response.ApplicationDetailsPath.FIELD_CATEGORY
import static com.lgi.appstore.metadata.api.testing.framework.model.response.ApplicationDetailsPath.FIELD_DESCRIPTION
import static com.lgi.appstore.metadata.api.testing.framework.model.response.ApplicationDetailsPath.FIELD_ICON
import static com.lgi.appstore.metadata.api.testing.framework.model.response.ApplicationDetailsPath.FIELD_NAME
import static com.lgi.appstore.metadata.api.testing.framework.model.response.ApplicationDetailsPath.FIELD_TYPE
import static com.lgi.appstore.metadata.api.testing.framework.model.response.ApplicationDetailsPath.FIELD_URL
import static com.lgi.appstore.metadata.api.testing.framework.model.response.ApplicationDetailsPath.FIELD_VISIBLE
